        ...
        <div className={`menu ${menu && "active"}`}>
          ...
          <ul className="menu_list">
            <li className="menu_item">
              <a href="#home" className="menu_link" onClick={closeMenu}>
                {t("navBar.nb1")}
              </a>
            </li>
            <li>
              <a href="#aboutme" className="menu_link" onClick={closeMenu}>
                {t("navBar.nb2")}
              </a>
            </li>
            <li>
              <a href="#projects" className="menu_link" onClick={closeMenu}>
                {t("navBar.nb3")}
              </a>
            </li>
            <li>
              <a href="#skills" className="menu_link" onClick={closeMenu}>
                {t("navBar.nb4")}
              </a>
            </li>
            <li>
              <a href="#contactme" className="menu_link" onClick={closeMenu}>
                {t("navBar.nb5")}
              </a>
            </li>
            <li className="menu_item">
