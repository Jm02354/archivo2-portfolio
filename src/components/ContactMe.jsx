        ...
        <div className="contactme_form">
          <div className="form_container">
            ...
            <div className="btncopy">
              <a href="mailto:josemariabion@hotmail.com">
                josemariabion@hotmail.com
              </a>
              <CopyToClipboard
                text="josemariabion@hotmail.com"
                onCopy={handleCopy}
              >
            ...
            <div className="form">
              <form ref={form} onSubmit={sendEmail}>
                ...
                <input
                  ...
                  required
                />
                <button className="send_btn" onClick={message} type="submit">
                  {t("contact.send")}
                </button>
              </form>
              <Toaster
